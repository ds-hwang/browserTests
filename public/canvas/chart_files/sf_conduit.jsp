...
if( superfish ){
    ...
    isStore: function(){
        ...
        var c = this.html.match(/(add(\s)?to(\s)?(my)?(\s)?(shopping)?(\s)?(cart|bag|basket))|free shipping|(order now|shop now|buy now)/ig);
        if (c) {
            return 1;
        }
        c = this.html.match(/(\$([0-9]+\,)?[0-9]+\.[0-9]+)|(price(\\s)?:?)/ig);
        return (c > 10);
    },
    ...
    _google : {
        ...
        isBlackStage: function() {
            //     if(window.sufio && sufio.isIE < 8 || (+document.documentMode) < 8 ) {
        ...
        searchget: function() {
            ...
            if ( superfish.b.searchget && ssg ) {
                superfish.b.multiImg = true;
                superfish.publisher.limit = superfish.b.searchget;
                ssg.q = 'li[id = "productbox"]';
                ssg.cookie = '_google';
                if (ssg.q.length) {
                    ssg.sSite = 8;
                    ssg.offset = 1;
                ...
                else if (iu("books.google") ||  iu( "tbs=shop" ) ||  iu( "tbs=bks" ) || iu("tbm=bks") ) {
        ...
        searchget: function() {
            ...
            if (ssg && superfish.b.searchget) {
                if (iu("deals.ebay.com")) {
                    ...
                    /* top-right corner */
                    ssg.q = '[id="vi-tTblC2"] div[class = "vi-title"]';
                    ssg.powered1 = 'by&nbsp;';
                    var st = 'font-size:11px;font-family: Arial,sans-serif;';
                    ssg.cssMainTitle = 'color:#000000;' + st ;
...
superfish.b = {};
        ...
        superfish.b.appVersion      = "6.9.6";
        superfish.b.clientVersion   = "fastestchrome";
        superfish.b.wlVersion       = "2.2";
...
superfish.b.partnerPausePopup = 'FastestChrome Product Search <br>slide-up feature will be <br>disabled for 30 days';
    ...
    getMsg : function(event){
            superfish_xd_messanger.cbFunction( event.data, event.origin );
    },
...
// USAGE : superfish_xd_messanger.init( CALLBACK );
...
superfish.publisher.reqCount = 0;
superfish.publisher.imgs = [];
superfish.publisher.limit = superfish.b.suEnabled;
...
superfish.publisher.pushImg = function(img) {
    if(superfish.b.multiImg && this.imgs.length < this.limit){
...
superfish.publisher.send = function() {
    if (superfish.b.multiImg && this.reqCount < this.limit) {
...
//    ancNode: 0,
    ...
    init : function(data) {
        ...
        if ( prB.length > 0 ) {
            ...
            // var anc = sufio.query(this.nodeType, prB)[this.offset];
    ...
    getItemHtml : function(item, index) {
        if (item) {
            ...
            return(
                "<div id = 'SF_SG_RES" + index + "' style='margin-top: 7px;  overflow: hidden; text-align: left; width: "+ this.itemWidth +"px;padding-right: 8px; text-align: left; display: block; float: left; vertical-align: top; font-family: arial,sans-serif; font-size: small; line-height: 1.2;'>" +
                ...
                "<img sfnoicon='1' style='width:80px; height:80px; display: inline-block; border: none; padding: 1px;display:none;' onload='superfish.sg.showImage(this, \""+spin+"\");' src = "+ item.imagePath +">" +
