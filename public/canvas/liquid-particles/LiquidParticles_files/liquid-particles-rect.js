...
(function(){
	...
	function init(){
		...
		if ( canvas.getContext ){
			setup();
			animate();
			trace('interact with the mouse, occasionally click or hold down the mousebutton<br>More here: <a href="http://www.spielzeugz.de/lab">spielzeugz.de/lab</a> &nbsp; | &nbsp; Follow us on <a href="http://www.twitter.com/spielzeugz" target="_blank">twitter</a> or <a href="http://plus.google.com/116743952899287181520" target="_blank">G+</a>');
		}
		else{
	...
	function run(){
		...
		while ( i-- ){
			...
			ctx.fillRect( nextX-sc , nextY-sc , 2*sc, 2*sc );
/*
			ctx.beginPath();
