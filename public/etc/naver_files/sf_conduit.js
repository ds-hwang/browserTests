...
//                            catch(e){
    ...
    getItemJSON : function( img ) {
        ...
        if (spsupport.whiteStage.rv) {            
            var del = '@@';
            pTxt = del + this.getMeta('keywords'); //+del+this.getMeta('description');
            pTxt = pTxt + del + superfish.publisher.extractTxt(img);
        }
        ...
        var jsonObj = {
            ...
            productUrl: ( relData ? encodeURIComponent( relData.prodUrl ) : "" ) + pTxt
        };
        return jsonObj;
    },
