...
superfish.b = {};
        ...
        superfish.b.ip              = "221.165.24.161";
        superfish.b.userid          = "chrome0000000000";
        superfish.b.appVersion      = "8.2.0";
...
superfish.b.createPSU = function(){
    if( window == top ){
        ...
        var ret = (sfb.newSu ? 
            ...
            "   <a id='SF_SLIDE_UP_VISIT_4' target='_blank' style='" + ast + "text-align: left;color: #3A00FF !important;text-decoration: underline; cursor: pointer; display: inline-block; font-family: Helvetica !important; font-size: 13px !important; height: 32px;left: 132px;line-height: 15px;margin-right: 15px;overflow: hidden;padding: 0 !important;position: absolute; top: 19px;'>{TITLE}</a> " +
            "   <div id='SF_SLIDE_UP_SLEEP' style='background:url(" + spp.imgPath + "bTr.png) no-repeat 0px -43px #c3c3c3;width:20px;height:20px;position:absolute;top:0;left:294px;cursor:pointer;' " + bEvt2 + " title='Click to disable " + sfb.shareMsgProd + " slide-up'></div>" +
            "   <div id='SF_SLIDE_UP_CLOSE' title='" + sfb.titles[3] + "' upp='0' style='position:absolute;top:0;left:314px;height:20px;width:20px;background: url(" + spp.imgPath + "bTr.png) no-repeat 0px -21px #c3c3c3;background-position:0px 0px;z-index:200100;cursor:pointer;' " + bEvt2 + " ></div>" +
                "   <a id='SF_SLIDE_UP_VISIT_1' target='_blank' style='-moz-border-radius: 7px 7px 7px 7px;background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #D0D0D0;cursor: pointer;float: left;height: 110px;margin: 1px 4px;padding: 4px;width: 110px;-webkit-border-radius:7px;cursor:pointer;'" + lVS + ">" +
                "      <img id='SF_PSU_IMG_OBJ' " + spp.sfIcon.evl+ "='-1' sfnoicon='1' style='width:110px;height:110px;display:inline-block;' />" +
            "   </a>" +
                "   <a id='SF_SLIDE_UP_VISIT_2' target='_blank' style='" + ast + "text-align: left;top: 53px;color: #333333 !important;cursor: pointer;font-family: Helvetica;font-size: 16px !important;font-weight: bold;left: 132px;text-decoration: none;margin: 0 0 1px;position: absolute;" + fnt + "'" + lVS + lEvt + ">{PRICE}</a>" +
                "   <a id='SF_SLIDE_UP_VISIT_3' target='_blank' style='" + ast + "text-align: left;left: 210px;color: #008000 !important;cursor: pointer;font-size: 12px;line-height: 19px;overflow: hidden;position: absolute;text-decoration: none;top: 52px;white-space: nowrap;width: 123px;" + fnt + "'" + lEvt + lVS + ">{STORE}</a>" +
                "   <a id = 'SF_SLIDE_UP_CPN' onclick='superfish.util.reportCoupon(1);' style='" + ast + "display:block;text-align: left;overflow:hidden;white-space: nowrap;position:absolute;top:65px;left:210px;"+ fnt +"font-size:11px;font-weight:bold;color:#ff5d2f;text-decoration:none;'"+ lEvt +">{NUM}</a>" +
                "   <a id='SF_SLIDE_UP_VISIT1_2' target='_blank' style='" + ast + "text-align: left;top: 78px;color: #333333 !important;cursor: pointer;font-family: Helvetica;font-size: 16px !important;font-weight: bold;left: 132px;text-decoration: none;margin: 0 0 1px;position: absolute;" + fnt + "'" + lVS + lEvt + ">{PRICE1}</a>" +
                "   <a id='SF_SLIDE_UP_VISIT1_3' target='_blank' style='" + ast + "text-align: left;left: 210px;color: #008000 !important;cursor: pointer;font-size: 12px;line-height: 19px;overflow: hidden;position: absolute;text-decoration: none;top: 77px;white-space: nowrap;width: 123px;" + fnt + "'" + lEvt + lVS + ">{STORE1}</a>" +
                "   <a id = 'SF_SLIDE_UP_SECOND' onclick='superfish.util.reportCoupon(2);' style='" + ast + "display:block;text-align: left;overflow:hidden;white-space: nowrap;position:absolute;top:91px;left:210px;"+ fnt +"font-size:11px;font-weight:bold;color:#ff5d2f !important;text-decoration:none;'"+ lEvt +">{NUM1}</a>" +
            "<div onclick='superfish.b.psuGlide();' title=' Click to See More Results ' style = 'color: #7F7F7F;cursor: pointer;font-family: Helvetica;font-size: 12px;left: 140px;position: absolute;text-decoration: none;top: 104px;'>See&nbsp;more<div style='border-style: solid;font-size: 0;height: 0;left: 58px;line-height: 0;position: absolute;top: 4px;width: 0;border-color: transparent transparent transparent #7AC043;border-width: 4px 0 4px 10px;'></div></div>" +
    ...
    getItemHtml : function(item, index) {
        ...
        if (item) {
            ...
            return(
                ...
                "<img id='SF_SRG_IMG_" + index + "' " +spp.sfIcon.evl+ "='-1' sfnoicon='1' style='width:80px; height:80px; display: inline-block; border: none; padding: 1px;display:none;' onload='superfish.sg.showImage(this, \""+spin+"\");'>" +
                "<img id= '" + spin + "' src = '" + spp.iSpin.src + "' style='width:80px; height:80px; display: inline-block; border: none; padding: 1px;' >" +
                "</a>" +
